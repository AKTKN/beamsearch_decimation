...
AF_BP_SOURCES = runpy.run_path(str(ROOT/'external_lib/ldpc/src_python/ldpc/af_bp/source_files.py'))['SOURCE_FILES']
PATHS['ldpc'] = list(dict.fromkeys([*PATHS['ldpc'], *HYBRID_SOURCES, *AF_BP_SOURCES]))
...
def main() -> None:
    ...
    from ldpc.af_bp import build_identity as af_bp_identity
    records['ldpc']['af_bp_build_identity']=af_bp_identity()
